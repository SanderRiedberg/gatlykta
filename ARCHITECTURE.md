...
- `data/osm.js`: livehämtning, cache, fallback och OSM-processing.
...
- Flytta OSM-processing till delbar kod så livehämtning och bundle-script använder exakt samma logik.
